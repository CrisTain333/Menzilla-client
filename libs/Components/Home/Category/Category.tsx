    ...
    return (
        <>
            ...
            <div className={`${styles.section} bg-white p-6 rounded-lg mb-12`} id="categories">
                <h1 className="text-4xl text-center font-bold mb-10">Category</h1>
                <div className="grid grid-cols-1 gap-[5px] md:grid-cols-2 md:gap-[10px] lg:grid-cols-4 lg:gap-6 xl:grid-cols-5 xl:gap-[30px]">
                    {categoriesData &&
